    ...
    public class UTMEditorTests : IClassFixture<AvaloniaTestFixture>
    {
        ...
        public void TestUtmEditorLoadExistingFile()
        {
            ...
            if (utmFiles.Length == 0)
            {
                ...
                Andastra.Parsing.Installation.ResourceResult utmResource = utmResources[0];
        ...
        public void TestUtmEditorManipulateNameLocstring()
        {
            ...
            UTM originalUtm = UTMHelpers.ConstructUtm(Andastra.Parsing.Formats.GFF.GFF.FromBytes(originalData));
            ...
            UTM modifiedUtm = UTMHelpers.ConstructUtm(Andastra.Parsing.Formats.GFF.GFF.FromBytes(data));
