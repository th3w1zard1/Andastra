...
namespace Andastra.Tests.Runtime.Games.Odyssey
{
    /// <summary>
    /// Comprehensive tests for OdysseyEntity serialization and deserialization.
    /// Tests all components, local variables, custom data, and edge cases.
    /// </summary>
    public class OdysseyEntitySerializationTests
    {
        [Fact]
        public void Serialize_WithBasicProperties_ShouldSucceed()
        {
            // Arrange
            var entity = new OdysseyEntity(123u, ObjectType.Creature, "test_creature");
            entity.AreaId = 456u;
        ...
        {
            // Arrange
            var originalEntity = new OdysseyEntity(123u, ObjectType.Creature, "test_creature");
            originalEntity.AreaId = 456u;

            // Act
            byte[] serialized = originalEntity.Serialize();
            var deserializedEntity = new OdysseyEntity(123u, ObjectType.Creature, "");
        ...
        {
            // Arrange
            var entity = new OdysseyEntity(123u, ObjectType.Door, "test_door");
            ...
            // Act
            byte[] serialized = entity.Serialize();
            var deserializedEntity = new OdysseyEntity(123u, ObjectType.Door, "");
            deserializedEntity.Deserialize(serialized);
        ...
        {
            // Arrange
            var entity = new OdysseyEntity(123u, ObjectType.Placeable, "test_placeable");
            ...
            // Act
            byte[] serialized = entity.Serialize();
            var deserializedEntity = new OdysseyEntity(123u, ObjectType.Placeable, "");
            deserializedEntity.Deserialize(serialized);
