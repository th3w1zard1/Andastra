...
{
    /// <summary>
    /// Comprehensive tests for EclipseEntity serialization and deserialization.
    /// Tests all components, local variables, custom data, and edge cases.
    /// </summary>
    public class EclipseEntitySerializationTests
    {
        [Fact]
        public void Serialize_WithBasicProperties_ShouldSucceed()
        {
            // Arrange
            var entity = new EclipseEntity(123u, ObjectType.Creature, "test_creature");
            entity.AreaId = 456u;
        ...
        {
            // Arrange
            var originalEntity = new EclipseEntity(123u, ObjectType.Creature, "test_creature");
            originalEntity.AreaId = 456u;

            // Act
            byte[] serialized = originalEntity.Serialize();
            var deserializedEntity = new EclipseEntity(123u, ObjectType.Creature, "");
