...
{
    /// <summary>
    /// Comprehensive tests for MDX.ksy Kaitai Struct compiler functionality.
    /// Tests compile MDX.ksy to multiple languages and validate the generated parsers work correctly.
    ///
    ...
    /// </summary>
    public class MDXKaitaiCompilerTests
    {
        private static readonly string MdxKsyPath = Path.Combine(
            Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location),
            "..", "..", "..", "..", "src", "Andastra", "Parsing", "Resource", "Formats", "MDL", "MDX.ksy");

        private static readonly string CompilerOutputDir = Path.Combine(Path.GetTempPath(), "kaitai_mdx_tests");
        ...
        static MDXKaitaiCompilerTests()
        {
            // Normalize MDX.ksy path
            MdxKsyPath = Path.GetFullPath(MdxKsyPath);
        ...
        [Fact(Timeout = 300000)]
        public void TestMdxKsyFileExists()
        {
            var normalizedPath = Path.GetFullPath(MdxKsyPath);
            File.Exists(normalizedPath).Should().BeTrue(
                $"MDX.ksy file should exist at {normalizedPath}"
            );

            // Verify it's a valid YAML file
            var content = File.ReadAllText(normalizedPath);
            content.Should().Contain("meta:", "MDX.ksy should contain meta section");
            content.Should().Contain("id: mdx", "MDX.ksy should have id: mdx");
            content.Should().Contain("seq:", "MDX.ksy should contain seq section");
        }

        [Fact(Timeout = 600000)] // 10 minute timeout for compiling all languages
        public void TestCompileMdxToAllLanguages()
        {
            string compilerPath = FindKaitaiCompiler();
            if (string.IsNullOrEmpty(compilerPath))
            {
            ...
            var normalizedKsyPath = Path.GetFullPath(MdxKsyPath);
        ...
        [Fact(Timeout = 300000)]
        public void TestCompileMdxToPython() => TestCompileToLanguage("python");

        [Fact(Timeout = 300000)]
        public void TestCompileMdxToJava() => TestCompileToLanguage("java");

        [Fact(Timeout = 300000)]
        public void TestCompileMdxToJavaScript() => TestCompileToLanguage("javascript");

        [Fact(Timeout = 300000)]
        public void TestCompileMdxToCSharp() => TestCompileToLanguage("csharp");

        [Fact(Timeout = 300000)]
        public void TestCompileMdxToCpp() => TestCompileToLanguage("cpp_stl");

        [Fact(Timeout = 300000)]
        public void TestCompileMdxToGo() => TestCompileToLanguage("go");

        [Fact(Timeout = 300000)]
        public void TestCompileMdxToRuby() => TestCompileToLanguage("ruby");

        [Fact(Timeout = 300000)]
        public void TestCompileMdxToPhp() => TestCompileToLanguage("php");

        [Fact(Timeout = 300000)]
        public void TestCompileMdxToRust() => TestCompileToLanguage("rust");

        [Fact(Timeout = 300000)]
        public void TestCompileMdxToSwift() => TestCompileToLanguage("swift");

        [Fact(Timeout = 300000)]
        public void TestCompileMdxToLua() => TestCompileToLanguage("lua");

        [Fact(Timeout = 300000)]
        public void TestCompileMdxToNim() => TestCompileToLanguage("nim");

        [Fact(Timeout = 300000)]
        public void TestCompileMdxToPerl() => TestCompileToLanguage("perl");

        [Fact(Timeout = 300000)]
        public void TestCompileMdxToVisualBasic() => TestCompileToLanguage("visualbasic");

        [Fact(Timeout = 300000)]
        public void TestCompileMdxToKotlin() => TestCompileToLanguage("kotlin");

        [Fact(Timeout = 300000)]
        public void TestCompileMdxToTypeScript() => TestCompileToLanguage("typescript");
