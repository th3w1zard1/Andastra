...
namespace HoloPatcher.UI.Views
{
    public partial class RteEditorWindow : Window
    {
        ...
        // Control fields - auto-generated by Avalonia from XAML x:Name attributes
        // These are declared here for reference but will be auto-generated by the compiler
        private ComboBox FontSizeComboBox => this.FindControl<ComboBox>("FontSizeComboBox");
        private ComboBox FontFamilyComboBox => this.FindControl<ComboBox>("FontFamilyComboBox");
        private ComboBox ForegroundComboBox => this.FindControl<ComboBox>("ForegroundComboBox");
        private ComboBox BackgroundComboBox => this.FindControl<ComboBox>("BackgroundComboBox");
        private RichTextBox Editor => this.FindControl<RichTextBox>("Editor");
