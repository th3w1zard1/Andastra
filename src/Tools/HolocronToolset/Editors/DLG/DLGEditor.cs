...
using CNVHelper = BioWare.NET.Resource.Formats.GFF.Generics.CNV.CNVHelper;
...
namespace HolocronToolset.Editors.DLG
{
    ...
    public class DLGEditor : Editor
    {
        ...
        public ContextMenu GetLinkContextMenu(Control sourceWidget, DLGStandardItem item)
        {
            ...
            // Note: Avalonia clipboard access is async, so we call it asynchronously
            // The clipboard check runs in the background; menu items will be enabled/disabled based on _copy state
