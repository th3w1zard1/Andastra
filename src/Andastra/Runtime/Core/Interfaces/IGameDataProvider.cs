...
namespace Andastra.Runtime.Core.Interfaces
{
    ...
    ///   - swkotor2.exe: 0x0041d2c0 @ 0x0041d2c0 (2DA table lookup), 0x0065a380 @ 0x0065a380 (GetCreatureRadius)
    ...
    public interface IGameDataProvider
    {
        ...
        /// <remarks>
        /// Based on reverse engineering:
        /// - swkotor2.exe: 0x0065a380 @ 0x0065a380 (GetCreatureRadius) calls 0x0041d2c0 to lookup "hitradius" from appearance.2da
        ...
        /// <remarks>
        /// Based on reverse engineering:
        /// - swkotor2.exe: 0x0041d2c0 @ 0x0041d2c0 (2DA table lookup)
        /// - swkotor.exe: Similar 2DA lookup system
        /// - nwmain.exe: C2DA::Load2DArray @ 0x1401a73a0 for 2DA loading
        /// - Generic table lookup method for accessing any game data table.
