...
namespace Andastra.Runtime.Games.Common.Save
{
    ...
    public abstract class BaseSaveGameManager
    {
        ...
        public abstract Task<bool> SaveGameAsync(SaveGameData saveData, string saveName, CancellationToken ct = default);
        ...
        public abstract Task<SaveGameData> LoadGameAsync(string saveName, CancellationToken ct = default);
