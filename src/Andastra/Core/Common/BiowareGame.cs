namespace Andastra.Core.Common
{
    ...
    // This enum is kept in BioWare.NET for backward compatibility with patcher tools (HoloPatcher.NET, HolocronToolset, NCSDecomp, KotorDiff)
    /// <summary>
