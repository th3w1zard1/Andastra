...
namespace Andastra.Runtime.Game.Core
{
    ...
    public class OdysseyGame : IDisposable
    {
        ...
        private void RenderCursor()
        {
            ...
            _spriteBatch.Draw(cursorTexture, renderPosition, new GraphicsColor(255, 255, 255, 255));
            _spriteBatch.End();
        }
        ...
        private void DrawMainMenu()
        {
            ...
            _graphicsDevice.Clear(new GraphicsColor(15, 15, 25, 255));
            ...
            Rectangle backgroundRect = new GraphicsRectangle(0, 0, viewportWidth, viewportHeight);
            _spriteBatch.Draw(_menuTexture, backgroundRect, new GraphicsColor(20, 20, 35, 255));
            ...
            if (_font != null)
            {
                ...
                _spriteBatch.DrawString(_font, title, titlePos + new GraphicsVector2(3, 3), new GraphicsColor(0, 0, 0, 180));
                // Draw main title text
                _spriteBatch.DrawString(_font, title, titlePos, new GraphicsColor(255, 215, 0, 255)); // Gold color
                ...
                _spriteBatch.DrawString(_font, subtitle, subtitlePos + new GraphicsVector2(2, 2), new GraphicsColor(0, 0, 0, 150));
                _spriteBatch.DrawString(_font, subtitle, subtitlePos, new GraphicsColor(200, 200, 220, 255));
                ...
                _spriteBatch.DrawString(_font, version, versionPos, new GraphicsColor(150, 150, 150, 255));
            }
            else
            {
                ...
                Rectangle glowRing = new GraphicsRectangle(titleX - 4, titleY - 4, titleSize + 8, titleSize + 8);
                DrawFilledCircle(_spriteBatch, glowRing, new GraphicsColor(255, 215, 0, 40));

                // Outer ring (gold) - filled circle with border
                Rectangle outerRing = new GraphicsRectangle(titleX, titleY, titleSize, titleSize);
                DrawFilledCircle(_spriteBatch, outerRing, new GraphicsColor(255, 215, 0, 255));
                DrawRoundedRectangle(_spriteBatch, outerRing, 6, new GraphicsColor(255, 200, 0, 255));

                // Inner ring (hollow) - creates elegant "O" shape by clearing center
                int innerSize = titleSize - 32;
                Rectangle innerRing = new GraphicsRectangle(titleX + 16, titleY + 16, innerSize, innerSize);
                DrawFilledCircle(_spriteBatch, innerRing, new GraphicsColor(15, 15, 25, 255)); // Clear with background color
                DrawRoundedRectangle(_spriteBatch, innerRing, 4, new GraphicsColor(255, 215, 0, 220));
            ...
            for (int i = 0; i < _menuItems.Length; i++)
            {
                ...
                GraphicsColor buttonBgColor;
                GraphicsColor buttonBorderColor;
                GraphicsColor buttonTextColor = new GraphicsColor(255, 255, 255, 255);
                float buttonScale = 1.0f;

                if (isSelected || isHovered)
                {
                    // Selected/hovered: bright blue with white border
                    buttonBgColor = new GraphicsColor(60, 120, 200, 255);
                    buttonBorderColor = new GraphicsColor(255, 255, 255, 255);
                    buttonScale = 1.05f; // Slightly larger when selected
                }
                else
                {
                    // Normal: dark blue-gray
                    buttonBgColor = new Andastra.Runtime.Graphics.Color(40, 50, 70, 220);
                    buttonBorderColor = new Andastra.Runtime.Graphics.Color(100, 120, 150, 255);
                }
                ...
                Rectangle scaledButtonRect = new GraphicsRectangle(scaledX, scaledY, scaledWidth, scaledHeight);

                // Draw button shadow (subtle)
                Rectangle shadowRect = new GraphicsRectangle(scaledButtonRect.X + 4, scaledButtonRect.Y + 4, scaledButtonRect.Width, scaledButtonRect.Height);
                _spriteBatch.Draw(_menuTexture, shadowRect, new GraphicsColor(0, 0, 0, 100));
                ...
                if (_font != null)
                {
                    ...
                    // Draw text shadow
                    _spriteBatch.DrawString(_font, _menuItems[i], textPos + new GraphicsVector2(2, 2), new GraphicsColor(0, 0, 0, 200));
                    // Draw main text
                ...
                else
                {
                    ...
                    Rectangle iconRect = new GraphicsRectangle(iconX, iconY, iconSize, iconSize);

                    GraphicsColor iconColor = isSelected ? GraphicsColor.White : new GraphicsColor(220, 220, 220, 255);
                    ...
                    if (i == 0)
                    {
                        ...
                        DrawTriangleOutline(_spriteBatch, triangleX, triangleY, new GraphicsColor(iconColor.R / 2, iconColor.G / 2, iconColor.B / 2, iconColor.A));
                    }
                    else if (i == 1)
                    {
                        // Options: Professional gear/settings icon (rounded square with plus)
                        int padding = 8;
                        Rectangle gearRect = new GraphicsRectangle(iconRect.X + padding, iconRect.Y + padding, iconSize - padding * 2, iconSize - padding * 2);
                        ...
                        // Horizontal bar
                        _spriteBatch.Draw(_menuTexture, new GraphicsRectangle(plusX - plusSize / 2, plusY + plusSize / 2 - plusThickness / 2, plusSize, plusThickness), iconColor);
                        // Vertical bar
                        _spriteBatch.Draw(_menuTexture, new GraphicsRectangle(plusX - plusThickness / 2, plusY, plusThickness, plusSize), iconColor);
                    }
                    else if (i == 2)
                    {
            ...
            if (_isSelectingPath && _availablePaths.Count > 0)
            {
                ...
                Rectangle pathSelectorRect = new GraphicsRectangle(centerX - pathSelectorWidth / 2, pathSelectorY, pathSelectorWidth, pathSelectorHeight + (Math.Min(_availablePaths.Count, maxVisiblePaths) * pathItemHeight));
                _spriteBatch.Draw(_menuTexture, pathSelectorRect, new GraphicsColor(30, 30, 45, 240));
                DrawRectangleBorder(_spriteBatch, pathSelectorRect, 2, new GraphicsColor(100, 120, 150, 255));
                ...
                if (_font != null)
                {
                    ...
                    _spriteBatch.DrawString(_font, pathTitle, titlePos + new GraphicsVector2(1, 1), new GraphicsColor(0, 0, 0, 150));
                    _spriteBatch.DrawString(_font, pathTitle, titlePos, new GraphicsColor(200, 200, 220, 255));
                }
                ...
                for (int i = startIndex; i < endIndex; i++)
                {
                    ...
                    if (isSelected)
                    {
                        DrawRectangleBorder(_spriteBatch, itemRect, 2, new GraphicsColor(255, 255, 255, 255));
                    }
                ...
                if (_font != null)
                {
                    ...
                    _spriteBatch.DrawString(_font, instructions, instPos + new GraphicsVector2(1, 1), new GraphicsColor(0, 0, 0, 150));
                    _spriteBatch.DrawString(_font, instructions, instPos, new GraphicsColor(150, 150, 170, 255));
                }
            }
            else
            {
                ...
                else
                {
                    ...
                    GraphicsColor indicatorColor = new GraphicsColor(180, 180, 200, 200);

                    // Draw subtle separator line
                    int lineWidth = 300;
                    int lineX = centerX - lineWidth / 2;
                    _spriteBatch.Draw(_menuTexture, new GraphicsRectangle(lineX, indicatorY - 15, lineWidth, 2), new GraphicsColor(100, 100, 120, 100));

                    // Arrow keys indicator (up arrow) - clean design
                    int arrowX = centerX - 120;
                    int arrowY = indicatorY;
                    // Arrow shaft
                    _spriteBatch.Draw(_menuTexture, new GraphicsRectangle(arrowX + indicatorSize / 2 - 1, arrowY, 2, indicatorSize), indicatorColor);
                    // Arrow head (triangle)
                    ...
                    int mouseX = centerX;
                    GraphicsRectangle mouseRect = new GraphicsRectangle(mouseX - indicatorSize / 2, arrowY - indicatorSize / 2, indicatorSize, indicatorSize);
                    ...
                    Rectangle enterRect = new GraphicsRectangle(enterX - indicatorSize, arrowY - indicatorSize / 2, indicatorSize * 2, indicatorSize);
                    ...
                    DrawFilledTriangle(_spriteBatch, enterArrowX, enterArrowY, new GraphicsColor(100, 100, 120, 255));
                }
            }
        ...
        private void DrawRectangleBorder(ISpriteBatch spriteBatch, Andastra.Runtime.Graphics.Rectangle rect, int thickness, GraphicsColor color)
        {
            // Top
            spriteBatch.Draw(_menuTexture, new GraphicsRectangle(rect.X, rect.Y, rect.Width, thickness), color);
            // Bottom
            spriteBatch.Draw(_menuTexture, new GraphicsRectangle(rect.X, rect.Y + rect.Height - thickness, rect.Width, thickness), color);
            // Left
            spriteBatch.Draw(_menuTexture, new GraphicsRectangle(rect.X, rect.Y, thickness, rect.Height), color);
            // Right
            spriteBatch.Draw(_menuTexture, new GraphicsRectangle(rect.X + rect.Width - thickness, rect.Y, thickness, rect.Height), color);
        }
        ...
        /// </summary>
        private void DrawFilledTriangle(ISpriteBatch spriteBatch, int[] x, int[] y, GraphicsColor color)
        {
        ...
        /// </summary>
        private void DrawLine(ISpriteBatch spriteBatch, int x1, int y1, int x2, int y2, int thickness, GraphicsColor color)
        {
            float dx = x2 - x1;
            float dy = y2 - y1;
            ...
            for (int i = 0; i < thickness; i++)
            {
                ...
                for (int j = 0; j <= lineLength; j++)
                {
                    ...
                    spriteBatch.Draw(_menuTexture, new GraphicsRectangle(px, py, 1, 1), color);
                }
            }
        }
        ...
        /// </summary>
        private void DrawDiagonalLine(ISpriteBatch spriteBatch, int x1, int y1, int x2, int y2, int thickness, GraphicsColor color)
        {
        ...
        private void DrawRoundedRectangle(ISpriteBatch spriteBatch, Andastra.Runtime.Graphics.Rectangle rect, int borderThickness, GraphicsColor color)
        {
            ...
            // Top edge
            spriteBatch.Draw(_menuTexture, new GraphicsRectangle(rect.X + cornerGap, rect.Y, rect.Width - cornerGap * 2, borderThickness), color);
            // Bottom edge
            spriteBatch.Draw(_menuTexture, new GraphicsRectangle(rect.X + cornerGap, rect.Y + rect.Height - borderThickness, rect.Width - cornerGap * 2, borderThickness), color);
            // Left edge
            spriteBatch.Draw(_menuTexture, new GraphicsRectangle(rect.X, rect.Y + cornerGap, borderThickness, rect.Height - cornerGap * 2), color);
            // Right edge
            spriteBatch.Draw(_menuTexture, new GraphicsRectangle(rect.X + rect.Width - borderThickness, rect.Y + cornerGap, borderThickness, rect.Height - cornerGap * 2), color);
            ...
            for (int y = -radius; y <= 0; y++)
            {
                for (int x = -radius; x <= 0; x++)
                {
                    ...
                    if (dist <= radius && dist >= radius - thickness)
                    {
                        ...
                        spriteBatch.Draw(_menuTexture, new GraphicsRectangle(drawX, drawY, 1, 1), color);
                    }
                }
            }
        }
        ...
        private void DrawFilledCircle(ISpriteBatch spriteBatch, Andastra.Runtime.Graphics.Rectangle bounds, GraphicsColor color)
        {
            ...
            for (int y = bounds.Y; y < bounds.Y + bounds.Height; y++)
            {
                for (int x = bounds.X; x < bounds.X + bounds.Width; x++)
                {
                    ...
                    if (dist <= radius)
                    {
                        spriteBatch.Draw(_menuTexture, new GraphicsRectangle(x, y, 1, 1), color);
                    }
                }
            }
        }
        ...
        private void DrawGameWorld()
        {
            ...
            _graphicsDevice.Clear(new GraphicsColor(135, 206, 250, 255)); // Sky blue
        ...
        {
            _graphicsDevice.Clear(new GraphicsColor(20, 20, 30, 255));
            ...
            _spriteBatch.DrawString(_font, title, titlePos, new GraphicsColor(255, 255, 255, 255));
            ...
            for (int i = startIdx; i < endIdx; i++)
            {
                ...
                if (i < _availableSaves.Count)
                {
                    ...
                    _spriteBatch.DrawString(_font, saveText, textPos, new GraphicsColor(255, 255, 255, 255));
                }
                else
                {
                    string newSaveText = "New Save";
                    GraphicsVector2 textPos = new GraphicsVector2(itemRect.X + 10, itemRect.Y + (itemHeight - _font.LineSpacing) / 2);
                    _spriteBatch.DrawString(_font, newSaveText, textPos, new GraphicsColor(211, 211, 211, 255));
                }
            }
            ...
            _spriteBatch.DrawString(_font, instructions, instPos, new GraphicsColor(211, 211, 211, 255));
            ...
            if (_isEnteringSaveName)
            {
                ...
                Rectangle inputBoxRect = new GraphicsRectangle(inputBoxX, inputBoxY, inputBoxWidth, inputBoxHeight);
                _spriteBatch.Draw(_menuTexture, inputBoxRect, new GraphicsColor(30, 30, 40, 255));

                // Draw border
                Rectangle borderRect = new GraphicsRectangle(inputBoxX - 2, inputBoxY - 2, inputBoxWidth + 4, inputBoxHeight + 4);
                _spriteBatch.Draw(_menuTexture, borderRect, new GraphicsColor(150, 150, 150, 255));
                ...
                _spriteBatch.DrawString(_font, label, labelPos, new GraphicsColor(255, 255, 255, 255));
                ...
                _spriteBatch.DrawString(_font, displayText, textPos, new GraphicsColor(255, 255, 255, 255));
            }
        ...
        private void DrawMoviesMenu()
        {
            ...
            if (_isPlayingMovie)
            {
                ...
                _spriteBatch.DrawString(_font, playingText, playingPos, new GraphicsColor(255, 255, 0, 255));
                _spriteBatch.End();
                return;
            }
            ...
            if (_availableMovies == null || _availableMovies.Count == 0)
            {
                ...
                _spriteBatch.DrawString(_font, noMoviesText, noMoviesPos, new GraphicsColor(211, 211, 211, 255));
            }
            else
            {
                int startY = 150;
                ...
                for (int i = startIdx; i < endIdx; i++)
                {
                    ...
                    GraphicsVector2 textPos = new GraphicsVector2(itemRect.X + 10, itemRect.Y + (itemHeight - _font.LineSpacing) / 2);
                    _spriteBatch.DrawString(_font, movieName, textPos, new GraphicsColor(255, 255, 255, 255));
                }
            }
