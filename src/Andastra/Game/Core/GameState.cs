namespace Andastra.Runtime.Game.Core
{
    ...
    /// - Module state management: 0x006caab0 @ 0x006caab0 sets module state flags in DAT_008283d4 structure
    ...
    ///   - Function signature: `undefined4 0x006caab0(char *param_1, int param_2)` - Parses server command strings like "S.Module.ModuleLoaded" or "S.Module.ModuleRunning"
    /// </remarks>
