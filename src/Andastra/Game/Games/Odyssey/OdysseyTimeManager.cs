...
namespace Andastra.Game.Games.Odyssey
{
    ...
    /// - swkotor2.exe: FUN_00401c30 @ 0x00401c30 - Frame update function (handles rendering, calls time update)
    ...
    ///   - Calls FUN_0040d4e0 with delta time to update game systems
    ///   - Handles OpenGL rendering (glClear, SwapBuffers)
    ///   - Used during save operations for progress updates (0.033333335 = 1/30s intervals)
    /// - swkotor.exe: FUN_00401c10 @ 0x00401c10 - Equivalent frame update function
    ///   Signature: void __cdecl FUN_00401c10(float param_1, int param_2, int param_3)
    ///   - Same behavior as swkotor2.exe version, different addresses
    /// 
    /// Time Update Functions:
    /// - swkotor2.exe: FUN_0040d4e0 @ 0x0040d4e0 - Time update function (updates game systems with delta time)
    ///   Signature: void __thiscall FUN_0040d4e0(void *this, float param_1)
    ///   - param_1: Delta time in seconds
    ///   - Calls FUN_00417ae0(param_1) - Game time update function
    ///   - Calls FUN_00414220(param_1) - Additional time update function
    ...
    /// - swkotor.exe: FUN_0040cc50 @ 0x0040cc50 - Equivalent time update function
    ///   Signature: void __thiscall FUN_0040cc50(void *this, float param_1)
    ///   - Same behavior as swkotor2.exe version, different addresses
    /// 
    /// Time Played Functions:
    /// - swkotor2.exe: FUN_0057a300 @ 0x0057a300 - Get time played in seconds
    ///   Signature: int __fastcall FUN_0057a300(int param_1)
    ...
    ///   - Calls FUN_0057a300 to get time played
    ///   - Writes TIMEPLAYED field to NFO GFF file
    ///   - Uses FUN_00401c30(0.033333335, 0, 0) for progress updates during save
    /// - swkotor.exe: FUN_004b3110 @ 0x004b3110 - Equivalent save serialization function
    ///   - Calls FUN_00401c10(0.033333335, 0, 0) for progress updates
    ///   - Similar behavior to swkotor2.exe version
    /// 
    /// Cross-Engine Notes:
    /// - swkotor.exe (KOTOR 1): Similar implementation with different function addresses
    ///   - Frame update: FUN_00401c10 @ 0x00401c10 (vs swkotor2.exe: FUN_00401c30 @ 0x00401c30)
    ///   - Time update: FUN_0040cc50 @ 0x0040cc50 (vs swkotor2.exe: FUN_0040d4e0 @ 0x0040d4e0)
    ///   - Save serialization: FUN_004b3110 @ 0x004b3110 (vs swkotor2.exe: SerializeSaveNfo @ 0x004eb750)
    ...
    public class OdysseyTimeManager : BaseTimeManager
    {
        ...
        /// - FUN_00401c30/FUN_00401c10 calls FUN_0040d4e0/FUN_0040cc50 with delta time
        /// - FUN_0040d4e0/FUN_0040cc50 updates game systems (module, AI, objects)
        ...
        public override void Update(float realDeltaTime)
        {
            ...
            // In original engine, FUN_00401c30/FUN_00401c10 would call FUN_0040d4e0/FUN_0040cc50 here
            // FUN_0040d4e0/FUN_0040cc50 updates game systems with delta time:
            // - Calls FUN_00417ae0(param_1) - Game time update
            // - Calls FUN_00414220(param_1) - Additional time update
        ...
        /// - Time update functions (FUN_00417ae0, FUN_00414220) are called by FUN_0040d4e0/FUN_0040cc50
        /// 
