...
namespace Andastra.Parsing.Extract
{
    ...
    internal static class FileResourceHelpers
    {
        ...
        private static List<(string resname, ResourceType restype, int offset, int size)> ReadErfResources(Andastra.Parsing.Common.RawBinaryReader reader, byte[] capsuleData)
        {
        ...
        private static List<(string resname, ResourceType restype, int offset, int size)> ReadRimResources(Andastra.Parsing.Common.RawBinaryReader reader, byte[] capsuleData)
        {
            var resources = new List<(string, ResourceType, int, int)>();
