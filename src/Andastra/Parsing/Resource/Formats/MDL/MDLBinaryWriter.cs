...
namespace Andastra.Parsing.Formats.MDL
{
    ...
    public class MDLBinaryWriter : IDisposable
    {
        ...
        private List<MDLData.MDLNode> _mdlNodes;
        ...
        private class _Node
        {
            ...
            public int IndicesOffsetsOffset(bool isK2)
            {
                int size = IndicesCountsOffset(isK2);
                if (Trimesh != null)
                {
                    size += Trimesh.IndicesCountsSize();
                }
                return size;
            }

            public int CountersOffset(bool isK2)
            {
                int size = IndicesOffsetsOffset(isK2);
                if (Trimesh != null)
                {
                    size += Trimesh.IndicesOffsetsSize();
                }
                return size;
            }
            ...
            public int VerticesOffset(bool isK2)
            {
                int size = CountersOffset(isK2);
                if (Trimesh != null)
                {
                    size += Trimesh.CountersSize();
                }
                return size;
            }
            ...
            {
                int size = ControllerDataOffset(isK2) + ControllerDataSize();
                if (Trimesh != null)
                {
                    size += Trimesh.IndicesCountsSize();
                    size += Trimesh.IndicesOffsetsSize();
        ...
        private void _UpdateNode(_Node binNode, MDLData.MDLNode mdlNode)
        {
        ...
        private void _UpdateAnim(_Animation binAnim, MDLData.MDLAnimation mdlAnim)
        {
            if (_game.IsK1())
            {
