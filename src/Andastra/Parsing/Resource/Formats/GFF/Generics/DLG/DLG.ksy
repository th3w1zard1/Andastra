...
doc: |
  ...
  with file type signature "DLG ".
  
  DLG files contain:
  - Root struct with conversation metadata (NumWords, Skippable, ConversationType, etc.)
  - EntryList: Array of DLGEntry structs (NPC dialogue lines)
  - ReplyList: Array of DLGReply structs (Player response options)
  - StartingList: Array of DLGLink structs (Entry points into the dialogue tree)
  - StuntList: Array of DLGStunt structs (Special dialog animations)
  ...
  gff_header:
    seq:
      - id: file_type
        ...
        size: 4
        doc: |
          File type signature. Must be "DLG " for dialogue files.
          Other GFF types: "GFF ", "ARE ", "UTC ", "UTI ", etc.
        valid: "DLG "
