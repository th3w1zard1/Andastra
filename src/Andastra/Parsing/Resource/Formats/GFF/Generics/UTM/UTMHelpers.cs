...
namespace Andastra.Parsing.Resource.Generics.UTM
{
    ...
    public static class UTMHelpers
    {
        ...
        // Engine loading functions: swkotor2.exe:0x00571310, swkotor.exe:0x005c7180
        public static UTM ConstructUtm(GFF gff)
        {
            ...
            // Note: ResRef and Comment are NOT read by the engine (swkotor2.exe:0x00571310, swkotor.exe:0x005c7180)
            utm.ResRef = root.Acquire<ResRef>("ResRef", ResRef.FromBlank());
            // Engine default: "" (invalid LocalizedString for new objects) (swkotor2.exe:0x00571310 line 50, swkotor.exe:0x005c7180 line 50)
            utm.Name = root.Acquire<LocalizedString>("LocName", LocalizedString.FromInvalid());
            // Engine default: "" (swkotor2.exe:0x00571310 line 41, swkotor.exe:0x005c7180 line 41)
            utm.Tag = root.Acquire<string>("Tag", "");
            // Engine default: 0 (swkotor2.exe:0x00571310 line 59, swkotor.exe:0x005c7180 line 59)
            utm.MarkUp = root.Acquire<int>("MarkUp", 0);
            // Engine default: 0 (swkotor2.exe:0x00571310 line 57, swkotor.exe:0x005c7180 line 57)
            utm.MarkDown = root.Acquire<int>("MarkDown", 0);
            // Engine default: "" (blank ResRef) (swkotor2.exe:0x00571310 line 65, swkotor.exe:0x005c7180 line 65)
            ...
            // Note: ID is NOT read by the engine (swkotor2.exe:0x00571310, swkotor.exe:0x005c7180)
            ...
            // Engine default: existing value, but 0 for new objects (swkotor2.exe:0x00571310 line 68, swkotor.exe:0x005c7180 line 68)
            ...
            // Engine default: empty list (engine skips if missing) (swkotor2.exe:0x00571310 line 74, swkotor.exe:0x005c7180 line 74)
            ...
            foreach (var itemStruct in itemList)
            {
                ...
                // Engine default: "" (blank ResRef) (swkotor2.exe:0x00571310 line 106, swkotor.exe:0x005c7180 line 106)
                ...
                // Engine default: 0 (swkotor2.exe:0x00571310 line 113, swkotor.exe:0x005c7180 line 113)
                ...
                // Note: Dropable is NOT read by the engine for UTM items (swkotor2.exe:0x00571310, swkotor.exe:0x005c7180)
