...
namespace Andastra.Parsing.Formats.SET
{
    /// <summary>
    ...
    /// - Based on nwmain.exe: CNWTileSet::LoadTileSet @ 0x1411e4684
    /// 
    /// File Structure:
    /// [GENERAL]
    /// DisplayName=<strref>
    ...
    /// - nwmain.exe: CNWTileSet::LoadTileSet @ 0x1411e4684
    /// - nwmain.exe: CNWTileSet::GetTileData @ 0x1402c67d0
