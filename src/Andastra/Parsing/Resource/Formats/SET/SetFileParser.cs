...
namespace Andastra.Parsing.Resource.Formats.SET
{
    /// <summary>
    ...
    /// - Based on nwmain.exe: CResSET::GetSectionEntryValue parses SET files
    /// - Format: INI-like with sections in brackets [SECTION] and key=value pairs
    /// - Sections: [GENERAL], [GRASS], [TILES], [TILE0], [TILE1], etc.
    /// - Based on reverse engineering of nwmain.exe: CNWTileSet::LoadTileSet @ 0x1402c6890
