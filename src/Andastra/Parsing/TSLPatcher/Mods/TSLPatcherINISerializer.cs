...
namespace Andastra.Parsing.Mods
{
    ...
    public class TSLPatcherINISerializer
    {
        ...
        private string SerializeTokenUsage(object tokenUsage)
        {
            ...
            if (tokenUsage is Andastra.Parsing.Memory.TokenUsageTLK tlkUsage)
            {
                return $"StrRef{tlkUsage.TokenId}";
            }
            if (tokenUsage is Andastra.Parsing.Memory.TokenUsage2DA twodaUsage)
            {
                return $"2DAMEMORY{twodaUsage.TokenId}";
            }
            if (tokenUsage is Andastra.Parsing.Memory.NoTokenUsage noToken)
            {
