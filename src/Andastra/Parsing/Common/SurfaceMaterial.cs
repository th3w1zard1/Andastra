...
namespace Andastra.Parsing.Common
{
    ...
    // Based on swkotor2.exe: Surface material walkability is hardcoded in the engine
    ...
    public static class SurfaceMaterialExtensions
    {
        ...
        // Based on swkotor2.exe: Material IDs 1, 3, 4, 5, 6, 9, 10, 11, 12, 13, 14, 16, 18, 20, 21, 22, 30 are walkable
