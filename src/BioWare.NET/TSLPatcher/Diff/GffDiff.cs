...
namespace BioWare.NET.TSLPatcher.Diff
{
    ...
    public static class GffDiff
    {
        ...
        private static bool ValuesAreEqual(object v1, object v2)
        {
            ...
            // Assuming BioWare.NET types implement Equals or are value types.
            // ResRef, LocalizedString, Vector3, Vector4 in BioWare.NET.Common should implement Equals.
