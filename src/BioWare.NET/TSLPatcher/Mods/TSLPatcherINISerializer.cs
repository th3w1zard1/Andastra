...
using TargetType = BioWare.NET.TSLPatcher.Mods.TwoDA.TargetType;
...
namespace BioWare.NET.TSLPatcher.Mods
{
    ...
    public class TSLPatcherINISerializer
    {
        ...
        private List<string> SerializeSsfFile(ModificationsSSF modSsf)
        {
            ...
            {
                if (modifier is BioWare.NET.TSLPatcher.Mods.SSF.ModifySSF modifySsf)
                {
        ...
        private string SerializeTokenUsage(object tokenUsage)
        {
            ...
            if (tokenUsage is BioWare.NET.TSLPatcher.Memory.TokenUsageTLK tlkUsage)
            {
                return $"StrRef{tlkUsage.TokenId}";
            }
            if (tokenUsage is BioWare.NET.TSLPatcher.Memory.TokenUsage2DA twodaUsage)
            {
                return $"2DAMEMORY{twodaUsage.TokenId}";
            }
            if (tokenUsage is BioWare.NET.TSLPatcher.Memory.NoTokenUsage noToken)
            {
