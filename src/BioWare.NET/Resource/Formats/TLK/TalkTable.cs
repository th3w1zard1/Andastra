...
namespace BioWare.NET.Resource.Formats.TLK
{
    ...
    public class TalkTable
    {
        ...
        public string GetString(int stringref)
        {
            ...
            byte[] textBytes = null;
            using (var reader = BioWare.NET.Common.RawBinaryReader.FromFile(_path))
            {
                reader.Seek(12);
        ...
        private static TLKData ExtractCommonTlkData(BioWare.NET.Common.RawBinaryReader reader, int stringref)
        {
