...
namespace BioWare.NET.Resource.Formats.GFF
{
    ...
    public class GFFBinaryWriter
    {
        ...
        private readonly BioWare.NET.Common.RawBinaryWriter _structWriter;
        private readonly BioWare.NET.Common.RawBinaryWriter _fieldWriter;
        private readonly BioWare.NET.Common.RawBinaryWriter _fieldDataWriter;
        private readonly BioWare.NET.Common.RawBinaryWriter _fieldIndicesWriter;
        private readonly BioWare.NET.Common.RawBinaryWriter _listIndicesWriter;
        ...
        {
            _gff = gff;
            _structWriter = BioWare.NET.Common.RawBinaryWriter.ToByteArray();
            _fieldWriter = BioWare.NET.Common.RawBinaryWriter.ToByteArray();
            _fieldDataWriter = BioWare.NET.Common.RawBinaryWriter.ToByteArray();
            _fieldIndicesWriter = BioWare.NET.Common.RawBinaryWriter.ToByteArray();
            _listIndicesWriter = BioWare.NET.Common.RawBinaryWriter.ToByteArray();
        }
        ...
        public byte[] Write()
        {
            ...
            using (var fileWriter = BioWare.NET.Common.RawBinaryWriter.ToByteArray())
            {
                // Write header
