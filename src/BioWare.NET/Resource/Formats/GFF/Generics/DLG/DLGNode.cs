...
using Color = BioWare.NET.Common.Color;
...
namespace BioWare.NET.Resource.Formats.GFF.Generics.DLG
{
    ...
    public abstract class DLGNode : IEquatable<DLGNode>
    {
        ...
        public Dictionary<string, object> ToDict(Dictionary<string, object> nodeMap = null)
        {
            ...
            if (FadeColor != null)
            {
                // Convert System.Drawing.Color to BioWare.NET.Common.Color to use ToBgrInteger()
                BioWare.NET.Common.Color Color = new BioWare.NET.Common.Color(
                    FadeColor.R / 255f,
                    FadeColor.G / 255f,
                    FadeColor.B / 255f,
                    FadeColor.A / 255f
