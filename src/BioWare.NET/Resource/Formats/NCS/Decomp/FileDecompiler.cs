...
using BioWare.NET.Resource.Formats.NCS.Decomp.Lexer;
using BioWare.NET.Resource.Formats.NCS.Decomp.Scriptutils;
using BioWare.NET.Resource.Formats.NCS.Decomp.Stack;
using BioWare.NET.Resource.Formats.NCS.Decomp.Utils;
using static BioWare.NET.Resource.Formats.NCS.Decomp.DecompilerLogger;

namespace BioWare.NET.Resource.Formats.NCS.Decomp
{
