...
namespace BioWare.NET.Resource.Formats.NCS.Decomp.Lexer
{
    public class Lexer
    {
        ...
        public Lexer(PushbackReader @in)
        {
            ...
            if (Lexer.gotoTable == null)
            {
                try
                {
                    System.IO.Stream stream = System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("BioWare.NET.Resource.Formats.NCS.Decomp.lexer.dat") ?? System.Reflection.Assembly.GetCallingAssembly().GetManifestResourceStream("BioWare.NET.Resource.Formats.NCS.Decomp.lexer.dat");
                    if (stream == null)
                    {
