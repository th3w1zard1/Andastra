...
using Formats = BioWare.NET.Resource.Formats;
    ...
    public static class Door
    {
            ...
            RobustLogger logger = null)
        {
            if (logger == null)
            {
                ...
                // logger = new BioWare.NET.Logger.RobustLogger();
            }
            ...
            RobustLogger logger = null)
        {
            ...
            foreach (string modelVar in modelVariations)
            {
                try
                {
                    ...
                    if (mdlResult != null && mdlResult.Data != null)
                    {
                        textureNames = BioWare.NET.Tools.ModelTools.IterateTextures(mdlResult.Data).ToList();
                        break;
                    }
                }
                catch
